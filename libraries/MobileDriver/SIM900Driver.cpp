...
static const prog_char R_OK[] PROGMEM = "OK";
static const prog_char R_ERROR[] PROGMEM = "ERROR";
static const prog_char R_SHUT_OK[] PROGMEM = "SHUT OK";
static const prog_char R_ANYTHING[] PROGMEM = "";

static const prog_char R_RDY[] PROGMEM = "RDY";
static const prog_char R_ANY_CFUN[] PROGMEM = "+CFUN: ?";
static const prog_char R_CGREG_1[] PROGMEM = "+CGREG: 1";
static const prog_char R_CGREG_3[] PROGMEM = "+CGREG: 3";
static const prog_char R_CGREG_5[] PROGMEM = "+CGREG: 5";
static const prog_char R_IPD[] PROGMEM = "+IPD,";
static const prog_char R_CMTI[] PROGMEM = "+CMTI: ";
static const prog_char R_CONNECT_OK[] PROGMEM = "CONNECT OK";
static const prog_char R_ALREADY_CONNECT[] PROGMEM = "ALREADY CONNECT";
static const prog_char R_SEND_OK[] PROGMEM = "SEND OK";
static const prog_char R_SEND_FAIL[] PROGMEM = "SEND FAIL";
static const prog_char R_SIMNOTREADY[] PROGMEM = "+CPIN: NOT READY";
static const prog_char R_PHONEBOOKENTRY[] PROGMEM = "+CPBF:";
// If AT is coming back as prefix of a response then we know it is really an echo. Run the anti echo command again.
static const prog_char R_ECHO_IS_ON[] PROGMEM = "AT";
static const prog_char R_RECEIVING_SMS[] PROGMEM = "+CMGR:";
static const prog_char R_SENT_SMS[] = "+CMGS:";

static const prog_char C_INIT0[] PROGMEM = "ATV1 E0 X1 S0=0 +CMEE=0";
static const prog_char C_READPHONEBOOK[] PROGMEM = "AT+CPBS=\"SM\";+CPBF=\"\"";
static const prog_char C_CONFIGURATION1[] PROGMEM = "AT+CGEREP=2,0;+CIURC=0;+CFGRI=1;+CIPHEAD=1";
static const prog_char C_CONFIGURATION2[] PROGMEM = "AT+CIPSPRT=1;+CMGF=1;+CIPCSGP=1,\"%s\"";
static const prog_char C_START1[] PROGMEM = "AT+CSTT";
static const prog_char C_START2[] PROGMEM = "AT+CIICR";
static const prog_char C_START3[] PROGMEM = "AT+CIFSR";
static const prog_char C_DATA_CONNECTION[] PROGMEM = "AT+CIPSTART=\"%s\",\"%s\",\"%s\"";
static const prog_char C_RESET[] PROGMEM = "AT+CFUN=1,1";
static const prog_char C_RESET_IP[] PROGMEM = "AT+CIPSHUT";
static const prog_char C_RECEIVE_SMS[] PROGMEM = "AT+CMGR=%s;+CMGD=%s";
static const prog_char C_TRANSMIT_SMS[] PROGMEM = "AT+CMGS=\"%s\"";
static const prog_char C_TRANSMIT_DATA[] PROGMEM = "AT+CIPSEND=%s";

// This anonymous namespace saves us trouble with conflicts with other non member decls
// that extern would have caused. Extern is necessary for forward decls, which we use.
namespace {
...
const MobileDriver::Transition T_READPHONEBOOK[] = {
		...
		// Phonebook does not work reliably. We will have to just continue after any error, effectively skipping
		// configuration.
		//MobileDriver::Transition(R_ERROR, &S_INITIAL),
		MobileDriver::Transition(R_ERROR, &S_CONFIGURATION1),
...
const MobileDriver::Transition T_CONFIGURATION2[] = {
		MobileDriver::Transition(R_OK, &S_START1),
		MobileDriver::Transition(R_ERROR, &S_RESET_IP) };

const MobileDriver::CommandState S_CONFIGURATION2 =
		MobileDriver::CommandState(C_CONFIGURATION2, 1, TRANSITIONS(T_CONFIGURATION2),
				&MobileDriver::apn);

const MobileDriver::Transition T_CONFIGURATION1[] = {
		MobileDriver::Transition(R_OK, &S_CONFIGURATION2),
		MobileDriver::Transition(R_ERROR, &S_INIT0) };

const MobileDriver::CommandState S_CONFIGURATION1 =
		MobileDriver::CommandState(C_CONFIGURATION1, 0, TRANSITIONS(T_CONFIGURATION1));
